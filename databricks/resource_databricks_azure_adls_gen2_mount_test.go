...
func TestAccAzureAdlsGen2MountWithAADPassthrough_correctly_mounts(t *testing.T) {
	terraformToApply := testAccAzureAdlsGen2MountWithAADPassthrough_correctly_mounts()
...
func testAccAzureAdlsGen2MountWithAADPassthrough_correctly_mounts() string {
	clientID := os.Getenv("ARM_CLIENT_ID")
	clientSecret := os.Getenv("ARM_CLIENT_SECRET")
	tenantID := os.Getenv("ARM_TENANT_ID")
	subscriptionID := os.Getenv("ARM_SUBSCRIPTION_ID")
